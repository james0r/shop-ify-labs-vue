...
const mutations = {
  [MUTATION_UPDATE_CART](state, cart) {
    cart.item_count = Object.values(cart.items).reduce((total, item) => {
...
const actions = {
  ...
  async [ACTION_ADD_TO_CART](context, products, errorCallback = () => {}) {
    context.commit(MUTATION_UPDATE_LOADING, true)
  ...
  async [ACTION_UPDATE_ORDER_NOTE](context, note, errorCallback = () => {}) {
    context.commit(MUTATION_UPDATE_LOADING, false)
